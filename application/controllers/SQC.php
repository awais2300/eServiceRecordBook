...
class SQC extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('sqc/dashboard', $data);
        } else {
    ...
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('sqc/daily_module'); //, $data);
        }
    }
    ...
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('sqc/add_punishment'); //, $data);
        }
    }
    public function add_excuse()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('sqc/add_excuse'); //, $data);
        }
    }
    public function add_observation()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('sqc/add_observation'); //, $data);
        }
    }
    public function PN_Form()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('sqc/pn_form1', $data);
        }
    }
    ...
    public function view_dossier()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('sqc/view_dossier', $data);
        }
    }
    ...
    public function view_academy_analytics()
    {
        if ($this->session->has_userdata('user_id')) {
            $data['divisions'] = $this->db->get('divisions')->result_array();
            $this->load->view('sqc/academy_analytics_master', $data);
        }
    }
    public function view_milestone_graph()
    {
        if ($this->session->has_userdata('user_id')) {
            $data['divisions'] = $this->db->get('divisions')->result_array();
            $this->load->view('sqc/academy_analytics', $data);
        }
    }
    public function view_academic_graph()
    {
        if ($this->session->has_userdata('user_id')) {
            $data['divisions'] = $this->db->get('divisions')->result_array();
            $this->load->view('sqc/view_academic_graph', $data);
        }
    }
    public function view_olq_graph()
    {
        if ($this->session->has_userdata('user_id')) {
            $data['divisions'] = $this->db->get('divisions')->result_array();
            $this->load->view('sqc/view_olq_graph', $data);
        }
    }
    public function get_academic_graph()
    {
        if ($this->input->post()) {
            ...
            $view_page = $this->load->view('sqc/view_academic_graph', $data, false);
            // echo $view_page;
    ...
    public function get_olq_graph()
    {
        if ($this->input->post()) {
            ...
            $data['cadet_data'] = $this->db->where('p_id', $p_id)->get('pn_form1s')->row_array();
            $view_page = $this->load->view('sqc/view_olq_graph', $data, false);
            // echo $view_page;
            json_encode($view_page);
        }
    }
    ...
    public function view_activity_log()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('sqc/activity_log', $data);
        }
    }
    ...
    public function get_graph_divisionwise()
    {
        ...
        echo $data = $this->load->view('sqc/academy_analytics', $data, TRUE);
    }
    ...
    public function view_punishment_list()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('sqc/view_punishment_list', $data);
        }
    }
    ...
    public function view_excuse_list()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('sqc/view_excuse_list', $data);
        }
    }
    public function view_observation_list()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('sqc/view_observation_list', $data);
        }
    }
    public function search_excuse_by_date()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $view_page = $this->load->view('sqc/view_excuse_list', $data, TRUE);
            echo $view_page;
            json_encode($view_page);
        }
    }
    public function search_punish_by_date()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['punishment_records'] = $this->db->get()->result_array();
            $data['search_date'] = $date;
            $view_page = $this->load->view('sqc/view_punishment_list', $data, TRUE);
            echo $view_page;
            json_encode($view_page);
        }
    }
    ...
    public function update_observation_status()
    {
        if ($this->input->post()) {
            ...
            $this->db->join('pn_form1s f', 'f.p_id = or.p_id');
            $data['observation_records'] = $this->db->get()->result_array();
            $view_page = $this->load->view('sqc/view_observation_list', $data, TRUE);
            echo $view_page;
            json_encode($view_page);
        }
    }
    ...
    public function search_all_cadets_for_dossier()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            if (count($data['pn_data']) > 0) {
                $view_page = $this->load->view('sqc/view_dossier', $data, TRUE);
                echo $view_page;
                json_encode($view_page);
            } else {
                echo '0';
    ...
    public function view_dossier_folder()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('sqc/view_dossier_folder', $data);
        }
    }
    ...
    public function search_cadet_for_dossier_folder()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            //     }
            // }
            // echo $this->session->userdata('unit_name'); exit;
            $data['pn_data'] = $this->db->where('oc_no', $oc_no)->where('unit_id', $this->session->userdata('unit_id'))->get('pn_form1s')->row_array();
            ...
            if ($data['pn_data'] != null) {
                $data['oc_no_entered'] = $oc_no;
                $view_page = $this->load->view('sqc/view_dossier_folder', $data, TRUE);
            } else {
                if ($ispress == 'Yes') {
    ...
    public function personal_data()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['divisions'] = $this->db->get('divisions')->result_array();
            $this->load->view('sqc/personal_data', $data);
        }
    }
    ...
    public function add_club()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('sqc/add_club', $data);
        }
    }
    ...
    public function Inspection_record()
    {
        if ($this->session->has_userdata('user_id')) {
            $data['pn_data'] = $this->db->get('pn_form1s')->result_array();
            $this->load->view('sqc/inspection_record', $data);
        }
    }
    ...
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('sqc/psychologist_report');
        }
    }
    ...
    public function add_inspection_record()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                $this->session->set_flashdata('success', 'Data Submitted successfully');
                redirect('SQC/Inspection_record');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('SQC/Inspection_record');
            }
    ...
    public function save_psychologist_report()
    {
        ...
        if (!empty($insert)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('SQC/psychologist_report');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('SQC/add_officer_qualities');
        }
    }
    ...
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('sqc/add_warning');
        }
    }
    ...
    {
        $this->load->view('sqc/Results');
    }

    public function view_semester_result()
    {
        // $this->load->view('sqc/view_semester_result_graph', false);
        $this->load->view('sqc/add_semester_result', false);
    }
    ...
    {
        $this->load->view('sqc/Sea_Training_Report');
    }

    public function view_general_remarks()
    {
        $this->load->view('sqc/add_general_remarks');
    }
    public function view_progress_chart()
    {
        $this->load->view('sqc/add_progress_chart');
    }
    public function view_distinction_records()
    {
        $this->load->view('sqc/add_distinction_records');
    }
    public function view_seniority_records()
    {
        $this->load->view('sqc/add_seniority_records');
    }
    public function view_record_div_officer()
    {
        $this->load->view('sqc/add_divisonal_officer_record');
    }
    public function view_promotion_screen()
    {
        $this->load->view('sqc/term_promotion');
    }
    ...
    public function save_distinction_records()
    {
        ...
        if (!empty($insert)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('SQC/view_distinction_records');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('SQC/view_distinction_records');
        }
    ...
    public function save_divisional_officer_records()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                redirect('SQC/view_record_div_officer');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('SQC/view_record_div_officer');
            }
    ...
    public function save_general_remarks()
    {
        ...
        if (!empty($insert)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('SQC/view_general_remarks');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('SQC/view_general_remarks');
        }
    ...
    public function save_cadet_progress()
    {
        ...
        if (!empty($insert) || !empty($update)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('SQC/view_progress_chart');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('SQC/view_progress_chart');
        }
    ...
    public function save_cadet_seniority_record()
    {
        ...
        if (!empty($insert) || !empty($update)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('SQC/view_seniority_records');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('SQC/view_seniority_records');
        }
    ...
    public function update_cadet_term()
    {
        if ($this->input->post()) {
            ...
            $data = '';
            $view_page = $this->load->view('sqc/term_promotion', $data, TRUE);
            echo $view_page;
            json_encode($view_page);
        }
    }
    ...
    public function add_branch_allocation()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('sqc/branch_allocation', $data);
        }
    }
    ...
    public function save_branches_allocation()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                redirect('SQC/add_branch_allocation');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('SQC/add_branch_allocation');
            }
    ...
    public function add_officer_qualities()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('sqc/officer_like_qualities', $data);
        }
    }
    ...
    public function update_officer_qualities()
    {
        ...
        if (!empty($insert)) {
            ...
            redirect('SQC/view_dossier_folder');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('SQC/view_dossier_folder');
        }
    ...
    public function punishment_records_report($oc_no = NULL, $term = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            // echo $term; exit;
            $data['term'] = $term;
            $html = $this->load->view('sqc/punishment_report', $data, TRUE); //$graph, TRUE);
    ...
    public function view_edit_punishment($row_id = null)
    {
        ...
        $this->load->view('sqc/edit_punishment', $data);
    }
    ...
    public function observation_records_report($oc_no = NULL, $term = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['term'] = $term;
            $html = $this->load->view('sqc/observation_report', $data, TRUE); //$graph, TRUE);
    ...
    public function view_edit_observation($row_id = null)
    {
        ...
        $this->load->view('sqc/edit_observation', $data);
    }
    ...
    public function warning_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['term'] = $term;
            $html = $this->load->view('sqc/warning_report', $data, TRUE); //$graph, TRUE);
    ...
    public function view_edit_warning($row_id = null)
    {
        ...
        $this->load->view('sqc/edit_warning', $data);
    }
    ...
    public function warning_record_insert_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/warning_insert_report', $data, TRUE);
    ...
    public function inspection_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['term'] = $term;
            $html = $this->load->view('sqc/inspection_report', $data, TRUE); //$graph, TRUE);
    ...
    public function view_edit_inspection($id = null)
    {
        ...
        $this->load->view('sqc/edit_inspection_record', $data);
    }
    ...
    public function medical_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['medical_records'] = $this->db->get()->result_array();
            $html = $this->load->view('sqc/medical_report', $data, TRUE); //$graph, TRUE);
    ...
    public function saluting_swimming_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/saluting_swimming_report', $data, TRUE); //$graph, TRUE);
    ...
    public function physical_efficiency_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/physical_efficiency_report', $data, TRUE); //$graph, TRUE);
    ...
    public function officer_qualities_records_report($oc_no = NULL, $term = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/officer_qualities_report', $data, TRUE); //$graph, TRUE);
    ...
    public function personal_data_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/personal_data_report', $data, TRUE); //$graph, TRUE);
    ...
    public function divisional_officer_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/divisional_officer_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function autobiography_record_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/autobiography_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function psychology_record_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/psychology_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function result_record_report($oc_no = NULL, $term = NULL, $doc_type = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/result_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function general_remarks_report($oc_no = NULL, $term = NULL, $type = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/general_remarks_report', $data, TRUE); //$graph, TRUE);
    ...
    public function progress_chart_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/progress_chart_report', $data, TRUE); //$graph, TRUE);
    ...
    public function distinction_achieved_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/distinction_achieved_report', $data, TRUE); //$graph, TRUE);
    ...
    public function seniority_record_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/seniority_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function branch_allocation_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('sqc/branch_allocation_report', $data, TRUE);
    ...
    public function view_edit_personal_record($id = null)
    {
        ...
        $this->load->view('sqc/edit_personal_data', $data);
    }
    ...
    public function view_edit_qualities($p_id = null)
    {
        ...
        $this->load->view('sqc/edit_officer_like_qualities', $data);
    }
    ...
    public function view_edit_officer_record($row_id = null)
    {
        ...
        $this->load->view('sqc/edit_officer_record', $data);
    }
    ...
    public function view_edit_biography($p_id = null)
    {
        ...
        $this->load->view('sqc/edit_cadet_autobiography', $data);
    }
    ...
    public function view_edit_psychologist_report($id = null)
    {
        ...
        $this->load->view('sqc/edit_psychologist_report', $data);
    }
    ...
    public function save_cadet_semester_result()
    {
        ...
        if (!empty($insert) || !empty($update)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('SQC/view_semester_result');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('SQC/view_semester_result');
        }
