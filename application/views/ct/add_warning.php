                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>CT/save_cadet_warning">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 mb-1">
                                    <input type="text" class="form-control form-control-user" name="division" id="division" style="font-weight: bold; font-size:large" placeholder="DIVSION" readonly>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 mb-1">
                                    ...
                                    <span id="error_end_date" style="font-size:10px; color:red; display:none">&nbsp;&nbsp;END DATE CANNOT BE LESS THEN START DATE</span>
                                </div>
                                <div class="col-sm-4 mb-1">
                                    <select class="form-control rounded-pill" name="warning_type" id="warning_type" data-placeholder="Warning Type" style="font-size: 0.8rem; height:50px;">
                                        ...
                                        <option class="form-control form-control-user" value="orange">EXECUTIVE OFFICER</option>
                                        <option class="form-control form-control-user" value="yellow">DIRECTOR OF STUDIES</option>
                                        <option class="form-control form-control-user" value="white">OFFICER INCHARGE</option>
                                        <option class="form-control form-control-user" value="white">SENIOR DIVISIONAL OFFICER</option>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 mb-1">
                                    <textarea class="form-control form-control-user" name="reason" id="reason" style="border-radius:10px" placeholder="ADD WAARNING"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12">
