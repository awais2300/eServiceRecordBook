...
<div class="container-fluid my-4">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="col-lg-4">
            <h1 class="h3 mb-0 text-white-800"><strong>WELCOME DIRECTOR OF STUDIES</strong></h1>
        </div>
        <div class="col-lg-4">
        ...
        <?php if($this->session->userdata('unit_id') == 1) { ?>
            ...
            <h1 class="h3 mb-0 text-white-800"><strong>PNS KARSAZ</strong></h1>
            </div>
        <?php } else { ?>
          <div class="col-lg-4" style="text-align:right">
                <h1 class="h3 mb-0 text-white-800"><strong><?= $this->session->userdata('unit_name') ?></strong></h1>
            </div>
        <?php } ?>
    </div> 
  <!--  <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="col-lg-6" style="text-align:right">
            <h1 class="h3 mb-0 text-white-800"><strong>TOTAL UTs: <?= $total_cadets['count']; ?></strong></h1>
        </div>
    </div> -->
</div>
