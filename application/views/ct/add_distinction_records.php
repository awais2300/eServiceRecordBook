...
<div class="container-fluid my-2">
    ...
    <div class="form-group row justify-content-center">
        ...
        <div class="col-lg-11">
            <h1 style="text-align:center; padding:40px"><strong>ADD HONOURS & AWARDS</strong></h1>
        </div>
    ...
    <div class="card-body bg-custom3">
        ...
        <div id="search_cadet" class="row my-2" style="display:none">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header bg-custom1">
                        <h1 class="h4">ADD HONOURS & AWARDS</h1>
                    </div>
                        ...
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>CT/save_distinction_records">
                            ...
                            <div class="form-group row">
                              ...
                              <!--  <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <h6>&nbsp;EXTRA CURICULLAR ACTIVITIES:</h6>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 mb-1">
                                    <input type="text" class="form-control form-control-user" name="academic" id="academic" placeholder="ACADEMICS">
                                </div>
                                <div class="col-sm-4 mb-1">
                                    <input type="text" class="form-control form-control-user" name="sports" id="sports" placeholder="SPORTS">
                                </div>
                                <div class="col-sm-4 mb-1">
                                    <input type="text" class="form-control form-control-user" name="extra_activites" id="extra_activites" placeholder="EXTRA CURICULLAR ACTIVITIES">
                                </div>
                            </div>
