                                    ...
                                    <tbody id="table_rows">
                                        ...
                                        foreach ($milestone_records as $data) { ?>
                                            <tr>
                                                ...
                                                <td type="button" class="edit" scope="row"><a style="color: black" href="<?= base_url(); ?>DEAN/add_physical_milestone/<?php echo "daily_module" ?>"><i style="" class="fas fa-edit"></i></a></td>
                                            </tr>
                                        <?php } ?>
