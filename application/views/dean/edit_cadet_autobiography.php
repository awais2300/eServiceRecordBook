        ...
        <div id="search_cadet" class="row my-2" style="display:block">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" enctype="multipart/form-data"  method="post" id="add_form_autobiography" action="<?= base_url(); ?>DEAN/update_autobiography/<?= $biography_data['id']  ?>">
