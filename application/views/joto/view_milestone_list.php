        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                        <a onclick="location.href='<?php echo base_url(); ?>JOTO/add_physical_milestone/milestone_list'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="float:right;margin-right:4px" data-toggle="modal" data-target="#all_projects"><i class="fas fa-plus-circle fa-sm text-white-60"></i> Add New Record </a>
                        </div>
                    </div>
                                    ...
                                    <tbody id="table_rows">
                                        ...
                                        foreach ($milestone_records as $data) { ?>
                                            <tr>
                                                ...
                                                <td type="button" class="edit" scope="row"><a style="color: black" href="<?= base_url(); ?>JOTO/add_physical_milestone/<?php echo "view_dossier_folder" ?>"><i style="" class="fas fa-edit"></i></a></td>
                                            </tr>
                                        <?php } ?>
