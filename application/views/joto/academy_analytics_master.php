...
<div class="container-fluid my-4">
    ...
    <div class="row">
        <div class="col-sm-4 mb-1">
            <a id="overall" onclick="location.href='<?php echo base_url(); ?>JOTO/view_academic_graph'" class="btn btn-md btn-primary shadow-md rounded-pill" style="border-radius:20px;width:100%; height:100%"><i class="fas fa-globe fa-md text-white-60"></i> Academic Graph</a>
        </div>
        <div class="col-sm-4 mb-1">
            <a id="termwise" onclick="location.href='<?php echo base_url(); ?>JOTO/view_olq_graph'" class="btn btn-md btn-primary shadow-md rounded-pill" style="border-radius:20px;width:100%;height:100%"><i class="fas fa-align-justify fa-md text-white-60"></i> OLQs Graph</a>
        </div>
        <div class="col-sm-4 mb-1">
            <a id="divisionwise" onclick="location.href='<?php echo base_url(); ?>JOTO/view_milestone_graph'" class="btn btn-md btn-primary shadow-md rounded-pill" style="border-radius:20px;width:100%;height:100%"><i class="fas fa-layer-group fa-md text-white-60"></i> Physical Milestone Graphs</a>
        </div>
