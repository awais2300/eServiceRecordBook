                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body bg-custom3">
                                    <form class="user" role="form" method="post" id="save_form_branches" action="<?= base_url(); ?>JOTO/update_branches_allocation">
                                        <div class="form-group row">
                                            <div class="col-sm-4">
                                                <h6>&nbsp;Name:</h6>
                                            </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body bg-custom3">
                                    ...
                                    <div class="card-body">
                                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>JOTO/update_cadet_warning">
                                            <div class="form-group row">
                                                <div class="col-sm-4">
                                                    <h6>&nbsp;Name:</h6>
                                                </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body bg-custom3">
                                    ...
                                    <div class="card-body">
                                        <form class="user" role="form" method="post" id="save_form_club" action="<?= base_url(); ?>JOTO/update_cadet_club">
                                            <div class="form-group row">
                                                <div class="col-sm-3">
                                                    <h6>&nbsp;Name:</h6>
                                                </div>
...
<script>
    function view_physical_milestone(id) {
        ...
        $.ajax({
            url: '<?= base_url(); ?>JOTO/view_milestone_in_dossier',
            method: 'POST',
            data: {
                'id': id
            },
                    ...
                    $("#milestone_details").html(`<form class="user" role="form" method="post" id="add_form" action="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2">
                                             ...
                                             <div class="col-sm-2">
                                                <a type="button" href="<?= base_url(); ?>JOTO/add_physical_milestone/<?php echo "dossier" ?>" class="btn btn-primary rounded-pill">Edit Record</a>
                                            </div>
                                        </div>
                                        <hr>
    ...
    function view_punishments(id) {
        // alert('cadet id: ' + id);
        $.ajax({
            url: '<?= base_url(); ?>JOTO/view_punishments_in_dossier',
            method: 'POST',
            data: {
                'id': id
            },
    ...
    function view_excuses(id) {
        // alert('cadet id: ' + id);
        $.ajax({
            url: '<?= base_url(); ?>JOTO/view_excuses_in_dossier',
            method: 'POST',
            data: {
                'id': id
            },
    ...
    function view_observations(id) {
        // alert('cadet id: ' + id);
        $.ajax({
            url: '<?= base_url(); ?>JOTO/view_observation_in_dossier',
            method: 'POST',
            data: {
                'id': id
            },
    ...
    function view_club(id) {
        // alert('cadet id: ' + id);
        $.ajax({
            url: '<?= base_url(); ?>JOTO/view_club_in_dossier',
            method: 'POST',
            data: {
                'id': id
            },
    ...
    function view_branches(id) {
        // alert('cadet id: ' + id);
        $.ajax({
            url: '<?= base_url(); ?>JOTO/view_branches_in_dossier',
            method: 'POST',
            data: {
                'id': id
            },
    ...
    function edit_branches(id) {
        // alert('cadet id: ' + id);
        $.ajax({
            url: '<?= base_url(); ?>JOTO/edit_branches_data',
            method: 'POST',
            data: {
                'id': id
            },
    ...
    function view_warning(id) {
        // alert('cadet id: ' + id);
        $.ajax({
            url: '<?= base_url(); ?>JOTO/view_warning_in_dossier',
            method: 'POST',
            data: {
                'id': id
            },
    ...
    function edit_warning(id) {
        // alert('cadet id: ' + id);
        $.ajax({
            url: '<?= base_url(); ?>JOTO/edit_warning_data',
            method: 'POST',
            data: {
                'id': id
            },
    ...
    function edit_club(id) {
        // alert('cadet id: ' + id);
        $.ajax({
            url: '<?= base_url(); ?>JOTO/edit_club_data',
            method: 'POST',
            data: {
                'id': id
            },
    ...
    function delete_club(id) {
        // alert('cadet id: ' + id);
        $.ajax({
            url: '<?= base_url(); ?>JOTO/delete_club_data',
            method: 'POST',
            data: {
                'id': id
            },
    ...
    $('#search_btn').on('click', function() {
        ...
        if (validate == 0) {
            ...
            $.ajax({
                url: '<?= base_url(); ?>JOTO/search_cadet_for_dossier',
                method: 'POST',
                data: {
                    'oc_no': oc_no
                },
    ...
    $('#show_all_btn').on('click', function() {
        ...
        if (validate == 0) {
            $('#error_search').hide();
            $.ajax({
                url: '<?= base_url(); ?>JOTO/search_all_cadets_for_dossier',
                method: 'POST',
                success: function(data) {
                    if (data != '0') {
                        var newDoc = document.open("text/html", "replace");
