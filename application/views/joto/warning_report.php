...
<div id="table_div">
  <?php if (count($warning_records) > 0) { ?>
    <table style="color:black">
      <thead style="border-top:1px solid black; font-weight:bold;padding:5px; text-align:center">
        <tr>
          <td scope="" style="width:120px">S NO</th>
          <td scope="" style="width:100px">DATE</th>
          <td scope="" style="width:100px">ISSUED BY</th>
          <td scope="" style="width:200px !important">REASONS</th>
          <td scope="" style="border-right:1px solid black;width:200px !important">DO'S SIGNATURE</th>
        </tr>
      </thead>
      <tbody id="table_rows_cont" style="border-top:1px solid black; padding:5px;">
        <?php $count = 0;
        foreach ($warning_records as $data) { ?>
          <tr>
            <td scope=""><?= ++$count; ?></td>
            <td scope=""><?= $data['date']; ?></td>
            <td scope="" style="height:50px"><?= $data['issued_by']; ?></td>
