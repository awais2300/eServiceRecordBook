...
<div class="container-fluid my-2">
    ...
    <div class="card-body bg-custom3" style="display:none" id="punish_term1">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                ...
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/punishment_records_report/<?= $pn_data['oc_no'] ?>/Term-I'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="punish_term2">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                ...
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/punishment_records_report/<?= $pn_data['oc_no'] ?>/Term-II'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="punish_term3">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                ...
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/punishment_records_report/<?= $pn_data['oc_no'] ?>/Term-III'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                                    ...
                                    <tbody id="table_rows_cont" style="border-top:1px solid black; padding:5px;width:100% !important">
                                        ...
                                        foreach ($pn_punish_data_term3 as $data) { ?>
                                            <tr>
                                                ...
                                                <td scope=""><?= $data['punishment_awarded']; ?></td>
                                                <td scope="" style="border-right:1px solid black;"><?= $data['awarded_by']; ?></td>
                                                <td scope="" style="border-right:1px solid black;text-align: center;"><a href="<?= base_url() ?>HOUGP/view_edit_punishment/<?= $data['id'] ?>" style="color: black"><i class="fa fa-edit"></i></a></td>
                                            </tr>
                                        <?php
                                            $count++;
                                        } ?>
    ...
    <div class="card-body bg-custom3" style="display:none" id="obs_term1">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <!--  <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_observation/<?= $pn_data['p_id']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:60%; margin-right:1%;"><i class="far fa-edit"></i> Edit Record</a> -->
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/observation_records_report/<?= $pn_data['oc_no'] ?>/Term-I'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                                    ...
                                    <tbody id="table_rows_cont" style="border-top:1px solid black; padding:5px;width:100% !important">
                                        ...
                                        foreach ($pn_obs_data_term1 as $data) { ?>
                                            <tr>
                                                ...
                                                <td scope="" style="border-right:1px solid black;text-align: center;"><a href="<?= base_url() ?>HOUGP/view_edit_observation/<?= $data['id'] ?>" style="color: black"><i class="fa fa-edit"></i></a></td>
                                            </tr>
                                        <?php
                                            $count++;
                                        } ?>
    ...
    <div class="card-body bg-custom3" style="display:none" id="obs_term2">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <!--  <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_observation/<?= $pn_data['p_id']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:60%; margin-right:1%;"><i class="far fa-edit"></i> Edit Record</a> -->
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/observation_records_report/<?= $pn_data['oc_no'] ?>/Term-II'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="obs_term3">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <!--  <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_observation/<?= $pn_data['p_id']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:60%; margin-right:1%;"><i class="far fa-edit"></i> Edit Record</a> -->
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/observation_records_report/<?= $pn_data['oc_no'] ?>/Term-III'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="warning_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <!-- <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_warning/<?= $pn_data['p_id']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:65%; margin-right:1%;"><i class="far fa-edit"></i> Edit Record</a> -->
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/warning_records_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                                    ...
                                    <tbody id="table_rows_cont" style="border-top:1px solid black; padding:5px;width:100% !important">
                                        ...
                                        foreach ($pn_warning_data as $data) { ?>
                                            <tr>
                                                ...
                                                <td scope="" style="border-right:1px solid black;text-align: center;"><a href="<?= base_url() ?>HOUGP/view_edit_warning/<?= $data['id'] ?>" style="color: black"><i class="fa fa-edit"></i></a></td>
                                            </tr>
                                        <?php
                                            $count++;
                                        } ?>
    ...
    <div class="card-body bg-custom3" style="display:none" id="warning_record_insert">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <!-- <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_warning/<?= $pn_data['p_id']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:65%; margin-right:1%;"><i class="far fa-edit"></i> Edit Record</a> -->
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/warning_record_insert_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="inspection_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/inspection_records_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                                    ...
                                    <tbody id="table_rows_cont" style="border-top:1px solid black; padding:5px;width:100% !important">
                                        ...
                                        foreach ($pn_inspection_data as $data) { ?>
                                            <tr>
                                                ...
                                                <td scope="" style="border-right:1px solid black;width:100px !important;text-align: center;"><a style="color: black;" href="<?php echo base_url() ?>HOUGP/view_edit_inspection/<?= $data['id']; ?>"><i class="fa fa-edit"></i></a></td>>
                                            </tr>
                                        <?php
                                            $count++;
                                        } ?>
    ...
    <div class="card-body bg-custom3" style="display:none" id="medical_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/medical_records_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="saluting_swimming_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/saluting_swimming_records_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="physical_efficiency_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                ...
                <a onclick="location.href='<?= base_url(); ?>HOUGP/add_physical_milestone/<?php echo "view_dossier_folder" ?>'" style="margin-left: 65%" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-edit text-white-50"></i> Edit Record</a>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/physical_efficiency_records_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="officer_qualities_record_term1">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_qualities/<?= $pn_data['p_id'] ?>/Term-I'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left: 65%"><i class="fas fa-edit text-white-50"></i> Edit Record</a>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/officer_qualities_records_report/<?= $pn_data['oc_no'] ?>/Term-I'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="officer_qualities_record_term2">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_qualities/<?= $pn_data['p_id'] ?>/Term-II'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left: 65%"><i class="fas fa-edit text-white-50"></i> Edit Record</a>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/officer_qualities_records_report/<?= $pn_data['oc_no'] ?>/Term-II'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="officer_qualities_record_term3">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_qualities/<?= $pn_data['p_id'] ?>/Term-III'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left: 65%"><i class="fas fa-edit text-white-50"></i> Edit Record</a>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/officer_qualities_records_report/<?= $pn_data['oc_no'] ?>/Term-III'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="personal_data_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_personal_record/<?= $pn_data['p_id']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:65%; margin-right:1%;"><i class="far fa-edit"></i> Edit Record</a>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/personal_data_records_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
    ...
    <div class="card-body bg-custom3" style="display:none" id="divisional_officer_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/divisional_officer_records_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                                    ...
                                    <tbody id="table_rows_cont" style="border-top:1px solid black; padding:5px;width:100% !important">
                                        ...
                                        foreach ($pn_divisional_officer_data as $data) { ?>
                                            <tr>
                                                ...
                                                <td scope="" style="border-right:1px solid black;"></td>
                                                <td scope="" style="height:50px;text-align: center;border-right:1px solid black"><a href="<?= base_url(); ?>HOUGP/view_edit_officer_record/<?= $data['id'] ?>" style="color: black"><i class="fa fa-edit"></i></a></td>
                                            </tr>
                                        <?php
                                            $count++;
                                        } ?>
    ...
    <div class="card-body bg-custom3" style="display:none" id="autobiography_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_biography/<?= $pn_data['p_id']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:65%; margin-right:1%;"><i class="far fa-edit"></i> Edit Record</a>

                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/autobiography_record_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="psychology_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_psychologist_report/<?= $pn_data['p_id']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:65%; margin-right:1%;"><i class="far fa-edit"></i> Edit Record</a>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/psychology_record_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="result_record_t1">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <!-- <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_result_report/<?= $pn_data['p_id']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:65%; margin-right:1%;"><i class="far fa-edit"></i> Edit Record</a>  -->
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/result_record_report/<?= $pn_data['oc_no'] ?>/Term-I/Result'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="result_record_t2">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <!-- <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_result_report/<?= $pn_data['p_id']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:65%; margin-right:1%;"><i class="far fa-edit"></i> Edit Record</a>  -->
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/result_record_report/<?= $pn_data['oc_no'] ?>/Term-II/Result'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="result_record_t3">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <!-- <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_ressult_report/<?= $pn_data['p_id']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:65%; margin-right:1%;"><i class="far fa-edit"></i> Edit Record</a>  -->
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/result_record_report/<?= $pn_data['oc_no'] ?>/Term-III/Result'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="sea_training_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <!-- <a onclick="location.href='<?php echo base_url() ?>HOUGP/view_edit_sea_training_report/<?= $pn_data['p_id']; ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:65%; margin-right:1%;"><i class="far fa-edit"></i> Edit Record</a>  -->
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/result_record_report/<?= $pn_data['oc_no'] ?>/Term-II/SeaTraining'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="general_remarks_term1_mid">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/general_remarks_report/<?= $pn_data['oc_no'] ?>/Term-I/Mid'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="general_remarks_term1_final">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/general_remarks_report/<?= $pn_data['oc_no'] ?>/Term-I/final'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="general_remarks_term2_mid">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/general_remarks_report/<?= $pn_data['oc_no'] ?>/Term-II/Mid'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="general_remarks_term2_final">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/general_remarks_report/<?= $pn_data['oc_no'] ?>/Term-II/final'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="general_remarks_term3_mid">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/general_remarks_report/<?= $pn_data['oc_no'] ?>/Term-III/Mid'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="general_remarks_term3_final">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/general_remarks_report/<?= $pn_data['oc_no'] ?>/Term-III/final'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="progress_chart_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/progress_chart_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="distinction_achieved_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/distinction_achieved_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="seniority_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/seniority_record_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
    ...
    <div class="card-body bg-custom3" style="display:none" id="branch_allocation_record">
        <?php if (isset($pn_data['name'])) { ?>
            <div class="d-sm-flex align-items-center justify-content-between mb-4 my-2">
                <h1 class="h3 mb-0 text-black-800"><strong> DOSSIER FOLDER </strong></h1>
                <a onclick="location.href='<?php echo base_url() ?>/HOUGP/branch_allocation_report/<?= $pn_data['oc_no'] ?>'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-print text-white-50"></i> Print Page</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
...
<script>
    $('#search_btn').on('click', function() {
        ...
        if (validate == 0) {
            ...
            $.ajax({
                url: '<?= base_url(); ?>HOUGP/search_cadet_for_dossier_folder',
                method: 'POST',
                data: {
                    'oc_no': oc_no
                },
