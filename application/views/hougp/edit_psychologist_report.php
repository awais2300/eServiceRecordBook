        ...
        <div id="search_cadet" class="row my-2" style="display:block">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" id="add_form_report" enctype="multipart/form-data"  action="<?= base_url(); ?>HOUGP/update_psychologist_report/<?= $psychologist_data['id'];?>">
