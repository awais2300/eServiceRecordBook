    ...
    <table style="color:black; width:100% !important;">
      ...
      <tbody id="table_rows_cont" style="border-top:1px solid black; padding:5px;width:100% !important">
        ...
        <tr>
          ...
          <tr>
            <td scope="" ><?= ++$count; ?></td>
            <td scope="">BOLDNESS,COURAGE AND STAMINA</td>
            <td scope="" style="text-align:center">10</td>
        ...
        <tr style="border-left: none;">
          <td scope="" style=" border-left:none"></td>
          <td scope="" style=" border-left:none"></td>
          <td scope="" colspan="3" style="border-right:1px solid black; height:70px;"> DO's SIGN </td>
        </tr>
        <tr>
          <td scope="" style="border-left:none"></td>
          <td scope="" style="border-left:none"></td>
        ...
        <tr style="border-left: none;">
          <td scope="" style=" border-left:none"></td>
          <td scope="" style=" border-left:none"></td>
          <td scope="" colspan="3" style="border-right:1px solid black; height:70px;"> SDO's SIGN </td>
        </tr>
        <tr>
          <td scope="" style="border-left:none"></td>
          <td scope="" style="border-left:none"></td>
        ...
        <tr style="border-left: none;">
          <td scope="" style=" border-left:none"></td>
          <td scope="" style=" border-left:none"></td>
          <td scope="" colspan="3" style="border-right:1px solid black; height:70px;"> OIC's SIGN </td>
        </tr>
        <tr>
          <td scope="" style="border-left:none"></td>
          <td scope="" style="border-left:none"></td>
        ...
        <tr style="border-left: none;">
          <td scope="" style=" border-left:none"></td>
          <td scope="" style=" border-left:none"></td>
          <td scope="" colspan="3" style="border-right:1px solid black; height:70px;"> COMMANDANT's SIGN </td>
        </tr>
        <tr>
          <td scope="" style="border-left:none"></td>
          <td scope="" style="border-left:none"></td>
