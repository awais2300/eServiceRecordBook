...
<div class="container-fluid my-2">
    ...
    <div class="form-group row justify-content-center">
        ...
        <div class="col-lg-11">
            <h1 style="text-align:center; padding:40px"><strong>PERSONALITY TRAITS GRAPH</strong></h1>
        </div>
    ...
    <div class="card-body bg-custom3">
        ...
        <div id="no_data" class="row my-2" style="display:none">
            <div class="col-lg-12 my-5">
                ...
                <h4 style="color:red">NO UT FOUND.PLEASE VHECK THE O NO ENTERED.</h4>
...
<script>
    window.onload = function() {
        ...
        var chart1 = new CanvasJS.Chart("chartContainer2", {
            ...
            axisY: {
                title: "Personality Traits Percentage ( Final)",
                maximum: 100,
                color:'blue'
            },
            data: [{
