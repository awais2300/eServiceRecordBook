...
<div class="container-fluid my-4">
    ...
    <div class="row">
        ...
        <div class="col-sm-3 mb-1">
            <a id="termwise" href="#" class="btn btn-md btn-primary shadow-md rounded-pill" style="border-radius:20px;width:100%;height:100%"><i class="fas fa-align-justify fa-md text-white-60"></i> TERMWISE MILESTONES GRAPH</a>
        </div>
        <div class="col-sm-3 mb-1">
        ...
        if (division != "ooo" && division != 'Overall' && division != 'termwise') {
            setTimeout(function() {
                ...
                var chart1 = new CanvasJS.Chart("chartContainer2", {
                    ...
                    title: {
                        text: division + " - UT PHYSICAL MILESTONES GRAPH"
                    },
                    subtitles: [{
                        text: "PERCENTAGE (%)"
                    }],
            ...
            setTimeout(function() {
                var chart1 = new CanvasJS.Chart("chartContainer2", {
                    ...
                    theme: "light2", // "light1", "light2", "dark1", "dark2"
                    title: {
                        text: "OVERALL UTs PHYSICAL MILESTONE ANALYTICS"
                    },
                    subtitles: [{
                        text: "PERCENTAGE (%)"
                    }],
