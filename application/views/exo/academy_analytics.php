...
<div class="container-fluid my-4">
    ...
    <div class="row">
        ...
        <div class="col-sm-3 mb-1">
            <a id="termwise" href="#" class="btn btn-md btn-primary shadow-md rounded-pill" style="border-radius:20px;width:100%;height:100%"><i class="fas fa-align-justify fa-md text-white-60"></i> TERM WISE MILESTONES GRAPH</a>
        </div>
        <div class="col-sm-3 mb-1">
            <a id="divisionwise" href="#" class="btn btn-md btn-primary shadow-md rounded-pill" style="border-radius:20px;width:100%;height:100%"><i class="fas fa-layer-group fa-md text-white-60"></i> CLASS WISE MILESTONE GRAPH</a>
        </div>
        <div class="col-sm-3 mb-1">
