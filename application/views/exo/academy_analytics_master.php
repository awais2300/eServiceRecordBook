...
<div class="container-fluid my-4">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-black-800"><strong>UNIT ANALYTICS</strong></h1>
    ...
    <div class="row">
        <div class="col-sm-4 mb-1">
            <a id="overall" onclick="location.href='<?php echo base_url(); ?>CO/view_academic_graph'" class="btn btn-md btn-primary shadow-md rounded-pill" style="border-radius:20px;width:100%; height:100%"><i class="fas fa-globe fa-md text-white-60"></i> ACADEMICS GRAPH</a>
        </div>
        <div class="col-sm-4 mb-1">
            <a id="termwise" onclick="location.href='<?php echo base_url(); ?>CO/view_olq_graph'" class="btn btn-md btn-primary shadow-md rounded-pill" style="border-radius:20px;width:100%;height:100%"><i class="fas fa-align-justify fa-md text-white-60"></i> PERSONALITY TRAITS GRAPH</a>
        </div>
        <div class="col-sm-4 mb-1">
