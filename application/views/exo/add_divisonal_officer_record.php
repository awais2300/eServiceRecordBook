...
<div class="container-fluid my-2">
    ...
    <div class="form-group row justify-content-center">
        ...
        <div class="col-lg-11">
            <h1 style="text-align:center; padding:40px"><strong>SDO/DO/ADO RECORD</strong></h1>
        </div>
    ...
    <div class="card-body bg-custom3">
        ...
        <div id="search_cadet" class="row my-2" style="display:none">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header bg-custom1">
                        <h1 class="h4">SDO/DO/ADO RECORD</h1>
                    </div>
                        ...
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>D_O/save_divisional_officer_records">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-1">
                                    <input type="text" class="form-control form-control-user" name="rank" id="rank" placeholder="NAME">
                                </div>
                                <div class="col-sm-6 mb-1">
                                    <input type="text" class="form-control form-control-user" name="officer_name" id="officer_name" placeholder="APPOINTMENT">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6">
