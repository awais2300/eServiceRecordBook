...
<div class="container-fluid my-2">
    ...
    <div class="form-group row justify-content-center">
        ...
        <div class="col-lg-11">
            <h1 style="text-align:center; padding:40px"><strong>ADD LEAVE</strong></h1>
        </div>
    ...
    <div class="card-body bg-custom3">
        ...
        <div id="search_cadet" class="row my-2" style="display:none">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header bg-custom1">
                        <h1 class="h4">LEAVE DETAILS</h1>
                    </div>

                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>D_O/save_cadet_leave">
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <h6>&nbsp;NAME:</h6>
                                </div>
...
<script>
    ...
    $('#save_btn').on('click', function() {
        ...
        if (nature == '') {
            validate = 1;
            $('#nature').addClass('red-border');
        }
        if (approved_by == '') {
            validate = 1;
            $('#approved_by').addClass('red-border');
        }
