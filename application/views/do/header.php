            ...
            <li class="nav-item">
                ...
                <div id="collapse_general" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url(); ?>CAO/auto_biography">NOK RECORD</a>
                        <a class="collapse-item" href="<?php echo base_url(); ?>CAO/view_record_div_officer">SDO/DO/ADO RECORDS</a>
                        <a class="collapse-item" href="<?php echo base_url(); ?>CAO/Inspection_record">INSPECTION RECORD</a>
                        <a class="collapse-item" href="<?php echo base_url(); ?>CAO/add_club">CLUBS</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapse_academic" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <?php if ($this->session->userdata('unit_id') == '1') { ?>
                            <a class="collapse-item" href="<?= base_url(); ?>CAO/view_training_report">BCT/ELC/NBCD/WHT/</a>
                        <?php } ?>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapse_assesment" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url(); ?>CAO/view_distinction_records">HONOURS & AWARDS</a>
                        ...
                        <a class="collapse-item" href="#">DEGREE COMPLETION</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
