                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>D_O/save_cadet_progress">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="olqs_t1" id="olqs_t1" placeholder="Enter Personality Traits Marks">
                                </div>
                                <div class="col-sm-3 mb-1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="olqs_t2" id="olqs_t2" placeholder="Enter Personality Traits Marks">
                                </div>
                                <div class="col-sm-3 mb-1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="olqs_t3" id="olqs_t3" placeholder="Enter Peronlity Traits Marks">
                                </div>
                                <div class="col-sm-3 mb-1">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3 mb-1">
                                    <input type="text" class="form-control form-control-user" name="term_t3" id="term_t3" value="TERM-IV" readonly>
                                </div>
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="academic_t3" id="academic_t3" placeholder="Enter Academic Marks">
                                </div>
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="olqs_t3" id="olqs_t3" placeholder="Enter Personality Traits Marks">
                                </div>
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="aggregate_t3" id="aggregate_t3" placeholder="Enter Aggregate">
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3 mb-1">
                                    <input type="text" class="form-control form-control-user" name="term_t3" id="term_t3" value="TERM-V" readonly>
                                </div>
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="academic_t3" id="academic_t3" placeholder="Enter Academic Marks">
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3 mb-1">
                                    <input type="text" class="form-control form-control-user" name="term_t3" id="term_t3" value="TERM-VI" readonly>
                                </div>
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="academic_t3" id="academic_t3" placeholder="Enter Academic Marks">
                                </div>
