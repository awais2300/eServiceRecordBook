                ...
                <div class="card">
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" id="save_form" action="<?= base_url(); ?>D_O/save_cadet_punishment">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 mb-1">
                                    <textarea class="form-control form-control-user" name="offense" id="offense" style="border-radius:10px" placeholder="ADD OFFENCE ETAILS"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-4">
