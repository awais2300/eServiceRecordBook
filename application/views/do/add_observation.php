    ...
    <div class="card-body bg-custom3">
        ...
        <div id="search_cadet" class="row my-2" style="display:none">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="POST"  enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>D_O/save_cadet_observation">
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <h6>&nbsp;NAME:</h6>
                                </div>
        ...
        <div id="no_data" class="row my-2" style="display:none">
            <div class="col-lg-12 my-5">
                ...
                <h4 style="color:red">NO UT FOUND. PLEAE CHECK O NO ENTERED.</h4>
