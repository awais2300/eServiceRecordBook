                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>D_O/save_cadet_seniority_record">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <h6>&nbsp;<strong>NO OF FAILED SUBJECTS :</strong></h6>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2 mb-1">
                                    <input type="text" class="form-control form-control-user" name="term_row_t3" id="term_row_t3" placeholder="TERM" value="TERM-IV" readonly>
                                </div>
                                <div class="col-sm-2 mb-1">
                                    <input type="number" class="form-control form-control-user" name="marks_t3" id="marks_t3" placeholder="ENTER MARKS">
                                </div>
                                ...
                                <div class="col-sm-2 mb-1">
                                    <input type="text" class="form-control form-control-user" name="term_row_t3" id="term_row_t3" placeholder="TERM" value="TERM-V" readonly>
                                </div>
                                <div class="col-sm-2 mb-1">
                                    <input type="number" class="form-control form-control-user" name="marks_t3" id="marks_t3" placeholder="ENTER MARKS">
                                </div>
                                ...
                                <div class="col-sm-2 mb-1">
                                    <input type="text" class="form-control form-control-user" name="term_row_t3" id="term_row_t3" placeholder="TERM" value="TERM-VI" readonly>
                                </div>
                                <div class="col-sm-2 mb-1">
                                    <input type="number" class="form-control form-control-user" name="marks_t3" id="marks_t3" placeholder="ENTER MARKS">
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-3">
                                    <h6>&nbsp;NET PERCENTAGE AT PNS KARSAZ:</h6>
                                </div>
                                <div class="col-sm-3">
