...
<div class="container-fluid my-2">
    ...
    <div class="form-group row justify-content-center">
        ...
        <div class="col-lg-11">
            <h1 style="text-align:center; padding:40px"><strong>EDIT PERSONALITY TRAITS</strong></h1>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header bg-custom1">
                        <h1 class="h4">FILL PERSONALTIY TRAITS FORM </h1>
                    </div>
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" id="save_form" action="<?= base_url(); ?>D_O/update_officer_qualities">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 mb-1">
                                    <input type="text" class="form-control form-control-user" name="division" value="<?= $officer_data['divison_name']; ?>" id="division" style="font-weight: bold; font-size:large" placeholder="CLASS" readonly>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <input type="date" class="form-control form-control-user" name="final_exam_date" value="<?= $officer_data['terminal_marks_date']; ?>" id="final_exam_date" placeholder="FINL MARKS %">
                                </div>
                            </div>
