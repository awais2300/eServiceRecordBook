...
<div class="container-fluid my-2">
    ...
    <div class="form-group row justify-content-center">
        ...
        <div class="col-lg-11">
            <h1 style="text-align:center; padding:40px"><strong>EDIT SDO/DO/ADO RECORD</strong></h1>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header bg-custom1">
                        <h1 class="h4">ADD SDO/DO/ADO RECORD</h1>
                    </div>
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>D_O/update_divisional_officer_records">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 mb-1">
                                    <input type="text" class="form-control form-control-user" name="division" id="division"value="<?=$divisional_officer_data['divison_name'];?>"style="font-weight: bold; font-size:large" placeholder="CLASS" readonly>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-1">
                                    <input type="text" class="form-control form-control-user" name="rank" value="<?= $divisional_officer_data['rank'];?>" id="rank" placeholder="RANK/NAME">
                                </div>
                                <div class="col-sm-6 mb-1">
                                    <input type="text" class="form-control form-control-user" name="officer_name" id="officer_name" value="<?= $divisional_officer_data['officer_name'];?>" placeholder="APPOINTMENT">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6">
