...
<div class="container-fluid my-2">
    ...
    <div class="card-body" style="padding:10px">
        ...
        <div class="card-body" style="margin-bottom:20px;float:right; padding:30px; margin-right:450px">
            <h1 style="text-align:center"><strong>EDIT UT's DIVISIONAL RECORD</strong></h1>
        </div>
    </div>
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" enctype="multipart/form-data"  method="post" id="add_form_autobiography" action="<?= base_url(); ?>D_O/update_autobiography/<?= $biography_data['id']  ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 mb-1">
                                    <input type="text" class="form-control form-control-user" name="division" id="division" value="<?= $biography_data['divison_name'] ?>" style="font-weight: bold; font-size:large" placeholder="CLASS" readonly>
                                </div>
                            ...
                            <div class="form-group row custom-file-upload">
                                <div class="col-sm-12 mb-1">
                                    <input type="file" style="height: 50px; padding:10px !important;" class="form-control form-control-user" placeholder="UPLOAD DOCUMENTS" x-model="fileName" multiple="multiple" id="autobiography" name="autobiography[]">
                                </div>
