...
<div class="container-fluid my-2">
    ...
    <div class="card-body" style="padding:10px">
        ...
        <div class="card-body" style="margin-bottom:20px;float:right; padding:30px; margin-right:450px">
            <h1 style="text-align:center"><strong>DIVISIONAL RECORD</strong></h1>
        </div>
    </div>
                        ...
                        <form class="user" role="form" enctype="multipart/form-data"  method="post" id="add_form_autobiography" action="<?= base_url(); ?>D_O/save_autobiography">
                            ...
                            <div class="form-group row justify-content-center">
                                <div class="col-sm-4">
                                    ...
                                    <span id="show_error_new" style="font-size:10px; color:red; display:none">&nbsp;&nbsp;PLEASE CHECK THE ERRORS*</span>
                                </div>
                            </div>
