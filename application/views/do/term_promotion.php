                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>D_O/save_cadet_warning">
                            ...
                            <div class="form-group row">
                                ...
                                <div id="cadets_term" class="col-sm-2 mb-1">
                                </div>

                                <div id="cadets_term_to" class="col-sm-2 mb-1">
                                </div>
    ...
    $("#term_list").on('change', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#cadets_oc_no").empty();
                $("#cadets_term").empty();
                $("#cadets_term_to").empty();

                var result = jQuery.parseJSON(data);
                var len = result.length;

                if (len > 0) {
                    $('#term_selected').html(`<strong>LIST OF UT's OF ${term}:</strong>`);
                    $("#cadets_oc_no").append(`<h6 style="text-decoration:underline;margin-bottom:10px;"><strong>O NO</strong></h6>`);
                    $("#list_of_cadets").append(`<h6 style="text-decoration:underline;margin-bottom:10px;"><strong>UT's NAME</strong></h6>`);
                    $("#cadets_term").html(`<h6 style="text-decoration:underline;margin-bottom:10px;"><strong>TERM FROM</strong></h6>`);
                    $("#cadets_term_to").html(`<h6 style="text-decoration:underline;margin-bottom:10px;"><strong>TERM TO</strong></h6>`);
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        $("#cadets_term").append(`<h6 style="margin-bottom:20px;"><strong>${term}</strong></h6>`);
                        $("#cadets_term_to").append(`<h6 style="margin-bottom:20px;"><strong>${next_term}</strong></h6>`);
                    }
                } else {
                    $('#term_selected').html(`<strong>NO UTs IN ${term}</strong>`);
                    $('#promote_all_btn_term3').hide();
                    $('#promote_all_btn_term4').hide();
                    $('#branch_list_term4').hide();
                    $('#unit_list_term3').hide();
