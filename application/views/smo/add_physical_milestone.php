                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body bg-custom3">
                                    <form class="user" role="form" method="post" id="add_form" action="<?= base_url(); ?>SMO/add_termI_details">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body bg-custom3">
                                    <form class="user" role="form" method="post" id="add_form2" action="<?= base_url(); ?>SMO/add_termII_details">
        ...
        <div id="search_cadet" class="row my-2" style="display:none">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" id="save_form" action="<?= base_url(); ?>SMO/save_physical_milestone">
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <h6>&nbsp;Name:</h6>
                                </div>
...
<script>
    $('#add_btn_termI').on('click', function() {
        ...
        $.ajax({
            url: '<?= base_url(); ?>SMO/add_termI_details',
            method: 'POST',
            //  type:'json',
            data: {
                'p_id': p_id,
    ...
    $('#add_btn_termII').on('click', function() {        
        ...
        $.ajax({
            url: '<?= base_url(); ?>SMO/add_termII_details',
            method: 'POST',
            //  type:'json',
            data: {
                'p_id': p_id,
    ...
    $('#add_btn').on('click', function() {
        ...
        if (validate == 0) {
            ...
            //alert('validate');
            $.ajax({
                url: '<?= base_url(); ?>SMO/search_cadet_physical_milestone',
                method: 'POST',
                data: {
                    'oc_no': oc_no
                },
