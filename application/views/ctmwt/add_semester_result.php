        ...
        <div id="search_cadet" class="row my-2" style="display:none">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>CTMWT/save_cadet_semester_result">
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <h6>&nbsp;Name:</h6>
                                </div>
...
<script>
    ...
    $('#add_btn').on('click', function() {
        ...
        if (validate == 0) {
            ...
            if ($('#name').val() != null) {
                $.ajax({
                    url: '<?= base_url(); ?>CTMWT/show_semester_results_values',
                    method: 'POST',
                    data: {
                        'p_id': $('#id').val()
                    },
            ...
            if ($('#name').val() != null) {
                $.ajax({
                    url: '<?= base_url(); ?>CTMWT/get_manual_result_files',
                    method: 'POST',
                    data: {
                        'p_id': $('#id').val()
                    },
