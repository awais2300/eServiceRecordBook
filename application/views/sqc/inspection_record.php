                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" id="add_form" action="<?= base_url(); ?>D_O/add_inspection_record">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 mb-1">
                                    <input type="text" class="form-control form-control-user" name="inspector_name" id="inspector_name" placeholder="INSPECTING OFFICER'NAME">
                                </div>
                            ...
                            <div class="form-group row justify-content-center">
                                <div class="col-sm-4">
                                    ...
                                    <span id="show_error_submit" style="font-size:10px; color:red; display:none">&nbsp;&nbsp;PLEASE FILL IN THE RQUIRED FIELDS.*</span>
                                </div>
                            </div>
                        </form>
                    </div>
