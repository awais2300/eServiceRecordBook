...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>SQC/view_dossier_folder" aria-expanded="true">
           ...
           <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>SQC/view_academy_analytics" aria-expanded="true">
        ...
        <!--    <li class="nav-item"> 
                <?php if ($this->session->userdata('unit_id') == '1') { ?>
                    <a class="nav-link collapsed" href="<?php echo base_url(); ?>SQC/personal_data" aria-expanded="true">
        ...
        <!--    <li class="nav-item">
                ...
                <div id="collapse_general" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <a class="collapse-item" href="<?php echo base_url(); ?>SQC/psychologist_report">DIVISIONAL RECORD</a>
                    <a class="collapse-item" href="<?php echo base_url(); ?>SQC/auto_biography">NOK FORM </a>
                    <a class="collapse-item" href="<?php echo base_url(); ?>SQC/Inspection_record">INSPECTION RECORD</a>
                    <a class="collapse-item" href="<?php echo base_url(); ?>SQC/view_record_div_officer">SDO/DO/ADO RECORDS
                    <a class="collapse-item" href="<?php echo base_url(); ?>SQC/add_club">ADD CLUB</a>
                        </a>
                    </div>
                </div>
            </li>  -->
             <li class="nav-item">
                ...
                <div id="collapse_discipline" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo base_url(); ?>SQC/daily_module">DAILY MODULE</a>
                    </div>
                </div>
            </li> 
             ...
             <li class="nav-item">
                ...
                <div id="collapse_warning" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo base_url(); ?>SQC/add_warning">ADD WARNING</a>
                    </div>
                </div>
            </li> 
         ...
         <!--   <li class="nav-item">
                ...
                <div id="collapse_academic" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url(); ?>SQC/view_semester_result"><?php if ($this->session->userdata('unit_id') != '1') { ?>Results (Terms VI - VIII)<?php } else { ?> Results (Terms I - III) <?php } ?></a>
                        <?php if ($this->session->userdata('unit_id') == '1') { ?>
                            <a class="collapse-item" href="<?= base_url(); ?>SQC/view_training_report">BTC/ELC/NBCD/WHT</a>
                        <?php } ?>
                    </div>
                </div>
            </li>  -->
            <!-- <li class="nav-item">
                ...
                <div id="collapse_assesment" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url(); ?>SQC/view_general_remarks">GENERAL REMARKS</a>
                    </div>
                </div>
            </li> -->
         <!--   <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>SQC/add_officer_qualities" aria-expanded="true">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>SQC/view_promotion_screen" aria-expanded="true">
           ...
           <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo base_url(); ?>SQC/view_activity_log" aria-expanded="true">
