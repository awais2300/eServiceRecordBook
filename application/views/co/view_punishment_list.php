                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body bg-custom3">
                                    <form class="user" role="form" method="post" id="save_form" action="<?= base_url(); ?>CO/update_punishment">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body bg-custom3">
                                    <form class="user" role="form" method="post" id="add_form" action="<?= base_url(); ?>CO/update_punishment">
                                        <div class="form-group row">
                                            <div class="col-sm-12">
...
<script>
    ...
    function edit_punishment(id) {
        // alert('punish id: ' + id);
        $.ajax({
            url: '<?= base_url(); ?>CO/edit_punishment_data',
            method: 'POST',
            data: {
                'id': id
